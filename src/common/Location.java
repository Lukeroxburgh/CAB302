...
public class Location {
    ...
    /**
     * Constructs a new common.Location object with the given x and y coordinates.
    ...
    /**
     * Parses the given string into a common.Location object.
     * @param s The string to parse, in the format "x,y"
     * @return The common.Location object parsed from the given string
     */
